...
*  Water levels at the pond have been low and it has been difficult to access some of the areas.  There are many more of the transient islands this year when compared to last year, likely the result of less rainfall and shallower depths.  
  

![The Pond in July ](20190806_122651.jpg)

##Plots
Below are the plots for the Hobos for the month of July.
...
a<-water_level %>% 
  ...
  ggtitle("July Water Level - Hourly means")+
...
b<-salinity %>% 
  ...
  theme_hoboplot()+
  scale_color_manual(values = hpal7, breaks=c("north", "mid", "south", "weir"), name="Station")+
  ggtitle("July Salinity - Hourly means")+
