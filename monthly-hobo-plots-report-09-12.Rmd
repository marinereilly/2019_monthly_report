...
* Beach walks post storm/high water

####January (expected)
* Salinity Surveys
* Hobo deployment to replace sondes if necessary

##Items of Note/Concern:
*  The channel that had opened in october is now closed but still at a lower elevation than the area around it.  (see photo)
*  Salinity has been decreasing since the overwash with the rain we've had

![Site of overwash during October High tide event on November 19, 2019](20191119_094142.jpg)

##Plots
Below are the plots for the Hobos for the month of November and December.
...
a<-water_level %>% 
  ...
  ggtitle("November and December Water Level")+
...
b<-salinity %>% 
  ...
  theme_hoboplot()+
  scale_color_manual(values = hpal7, breaks=c("north", "mid", "south", "weir"), name="Station")+
  ggtitle("November and December Salinity")+
